...
const translations = {
  zh: {
    ...
    "hero.cardText": "无需后端或 API Key，使用本地健康信息知识库和关键词匹配规则展示检索流程。",
    "hero.cardPoint1": "关键词匹配",
    "hero.cardPoint2": "风险等级提示",
  ...
  en: {
    ...
    "hero.cardTitle": "Front-end Rule-based Demo",
    "hero.cardText": "No backend or API key is required. The page uses a local health information dataset and keyword matching rules to demonstrate the retrieval workflow.",
    "hero.cardPoint1": "Keyword matching",
    "hero.cardPoint2": "Risk level reminder",
